...
namespace vel
{
	...
	public:
		void SetPerspective(float verticalFOV = 45.0f, float nearClip = 0.1f, float farClip = 1000.0f);
		...
		glm::vec3 Position = glm::vec3(0.f, 1.5f, -3.f);
		glm::vec3 Target = { 0.f, 1.5f, 0.f };
	private:
